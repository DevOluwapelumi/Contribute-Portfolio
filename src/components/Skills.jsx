        ...
        <div className="wrapper pb-5">
          <div className="marquee text-white">
            <div className="marquee__group">
                ...
                <span className="skill-icons--bootstrap hidden"><h6 className="">BOOTSTRAP</h6></span>
                <span className="skill-icons--tailwindcss-dark hidden"><h6 className="">TAILWIND</h6></span>
                <span className="skill-icons--github-dark hidden"><h6 className="">GITHUB</h6></span>
                <span className="logos--nodejs hidden"><h6 className="">NODE JS</h6></span>
                <span className="skill-icons--wordpress hidden"><h6 className="">WORDPRESS</h6></span>
                <span className="skill-icons--figma-dark hidden"><h6 className="">FIGMA</h6></span>
            </div>
